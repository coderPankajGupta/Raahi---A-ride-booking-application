...
export default function ActionCard({icon,title,button,onclick}:any) {
  return (
    <div className="bg-white rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 shadow-lg border flex flex-col sm:flex-row justify-between items-center sm:items-center gap-5">
