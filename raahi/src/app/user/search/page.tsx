    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900 overflow-x-hidden">
      ...
      >
        <div className="px-5 lg:px-8 max-w-6xl mx-auto">
          ...
          >
            <div>
              <h2 className="text-zinc-900 text-lg ">
                {loading
                  ? "Finding nearby vehicles..."
                  : vehicles.length > 0
                    ? `Found nearby vehicles`
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                <motion.div
                  ...
                  className="flex items-center gap-2 bg-zinc-100 border border-zinc-200 px-3 py-2.5 rounded-full"
                >
            ...
            {!loading && vehicles.length == 0 && (
              ...
              >
                ...
                <p className="text-zinc-400 text-sm max-w-xs leading-relaxed">
                  {meta.label || "Vehicle"} drivers are not available near you
                  for pickup right now.{" "}
                </p>
