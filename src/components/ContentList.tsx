...
export default function ContentList({ data, type }: any) {
  ...
  async function handleStartVideoKyc(id:any) {
    try {
      ...
      {data.map((item: any, idx: number) => {
        ...
        return (
          <motion.div
            ...
            className="bg-white border border-gray-100 rounded-e-2xl px-5 py-4 flex items-center justify-between gap-4 shadow-sm transition-shadow"
          >
